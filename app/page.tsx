...
export default function Home() {
  ...
  const bgIndonesia = "https://images.unsplash.com/photo-1555899434-94d1369418af?q=80&w=2070&auto=format&fit=crop";
  ...
  return (
    <main className="min-h-screen text-white flex flex-col items-center p-4 relative">
      ...
      <div className="fixed inset-0 z-0 bg-cover bg-center" style={{ backgroundImage: `url(${bgIndonesia})` }} />
      ...
      <div className="w-full max-w-5xl flex flex-col flex-grow z-10">
        ...
        <div className="flex gap-2 w-full mb-8">
          <input
            ...
            placeholder="makan bakmie ayam abis gajian"
        ...
        {result && (
          <div className="space-y-8 animate-fadeIn flex-grow">
            {/* UPGRADE: GANTIIN 3 KOTAK WARNA GEDE */}
            ...
            {/* KOTAK WARNA PINDAH KE BAWAH, DIKECILIN */}
